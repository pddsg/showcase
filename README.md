...
<br><br>What you see here are multiple graphs showing the overfill of individual, active components in soft gel capsules (SGC) relative to their specification limits. Each line corresponds with one product batch. The product batches are SGC from various contract manufacturers. 
