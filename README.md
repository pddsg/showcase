...
<br><br>What you see here are multiple graphs showing the overfill of individual components relative to their specification limits. Each line corresponds with one product batch. The product batches are capsules from various contract manufacturers. 
...
- <br> Trending over time
- <br> Comparison between manufacturers
- <br> Drilling down to individual batches using filters
- <br> Ad-hoc loading of <i>all</i> QC data of any individual batch directly from the data warehouse via a built-in point & click trigger.
